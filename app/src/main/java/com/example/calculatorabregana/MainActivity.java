package com.example.calculatorabregana;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        digitBtnListenerMethod();
    }

    public void digitBtnListenerMethod() {
        View.OnClickListener digitListener = new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText etNumInput = (EditText) findViewById(R.id.etNumInput);
                Button btn = (Button) view;
                etNumInput.setText(etNumInput.getText() + "" + btn.getText());
            }
        };
